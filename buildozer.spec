...
package.domain = org.dormlife

# (str) Source code where the main.py live
source.dir = .

# (list) Source files to include (leave empty to include all the files)
source.include_exts = py,png,jpg,kv,atlas,json,txt,ttf,otf,ttc

# (list) List of inclusions using pattern matching
source.include_patterns = profiles/**/*.json

# (list) Source files to exclude (leave empty to not exclude anything)
#source.exclude_exts = spec

# (list) List of directory to exclude (leave empty to not exclude anything)
source.exclude_dirs = tests, bin, backup, .buildozer, __pycache__

# (list) List of exclusions using pattern matching
# Do not prefix with './'
source.exclude_patterns = *backup*.py,*backup*.json,*.zip,*.Zone.Identifier,crash.log
...
requirements = python3,kivy==2.3.1,httpx
