...
> **当前版本**：v0.9.0（代码模块化拆分 + 4个 Bug 修复）  
> **报告日期**：2026年6月26日（v0.8.7 + v0.9.0 同日发布）
...
- [ ] Android APK 最终编译与真机验证（纯 Kivy v0.8.5，零 KivyMD 依赖）
...
| 产物 | 平台 | 位置 | 状态 |
|------|------|------|------|
| ChatRoom APK v0.9.0 | Android | [GitHub Releases](https://github.com/bowenzhang01/ChatRoom/releases/tag/v0.9.0) | ✅ 已发布 |
